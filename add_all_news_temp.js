...
for (let i = 0; i < files.length; i++) {
  ...
  // JSON.stringify will emit \n as literally \ and n, which is good.
...
// FIX: Wait! I just noticed I still have the comma operator bug.
// `newsTsContent = newsTsContent.substring(0, insertPos) + '\\n' + objStr + ',', + newsTsContent.substring(insertPos);`
// is STILL WRONG in the source string here! I must fix it below.
