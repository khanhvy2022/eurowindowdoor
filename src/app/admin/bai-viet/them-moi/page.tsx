    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-2xl font-black text-gray-900">Thêm Bài Viết Mới</h1>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="date" name="date" value={formData.date} onChange={handleChange} className="w-full px-3 py-2 text-xs border rounded-xl focus:ring-[#005ba7]" />
              </div>
              <div>
                <label className="block text-xs font-semibold text-gray-700 mb-1">Link Ảnh Cover</label>
                <input type="text" name="image" value={formData.image} onChange={handleChange} placeholder="/images/news/..." className="w-full px-3 py-2 text-xs border rounded-xl focus:ring-[#005ba7]" />
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl border border-red-100">
            ...
            <p className="text-xs text-gray-600 leading-relaxed mb-4">
              Bài viết hiện đạt <strong className="text-red-600">{seoResult?.overallScore} điểm SEO</strong> (dưới ngưỡng khuyến nghị 60). Việc đăng bài viết chất lượng SEO thấp có thể ảnh hưởng đến thứ hạng website Eurowindow trên Google.
            </p>
