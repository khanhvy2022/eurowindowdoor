...
function ProductsContent() {
  ...
  useEffect(() => {
    if (catParam) {
      if (catParam.includes('nhôm')) setSelectedCategory('Cửa nhôm');
      else if (catParam.includes('uPVC')) setSelectedCategory('Cửa uPVC');
      else if (catParam.includes('gỗ')) setSelectedCategory('Cửa gỗ');
      else if (catParam.includes('cuốn')) setSelectedCategory('Cửa cuốn');
      else if (catParam.includes('tự động')) setSelectedCategory('Cửa tự động');
      else if (catParam.includes('kính')) setSelectedCategory('Sản phẩm kính');
      else if (catParam.includes('thông minh')) setSelectedCategory('Cửa thông minh');
    }
  }, [catParam]);
